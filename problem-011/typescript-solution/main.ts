...
const solution = (matrix: number[][], k: number) => {
    let best = 0; // track the current best solution
    const size: number = 20; // static sized matrix of 20x20
...
console.log("Project Euler, Problem 11: ", solution(matrix, 4));